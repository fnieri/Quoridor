...
json GameRelatedActionsSerializableMessageFactory::serializeQueueJoinRequest(QueueAction queueAction, GameMode gameMode, std::string &username, int ELO)
{
...
json GameRelatedActionsSerializableMessageFactory::serializeInGameRelatedRequest(GameAction gameAction, std::string &username)
{
    json requestJson = {
