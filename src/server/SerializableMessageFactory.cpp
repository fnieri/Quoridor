...
json SerializableMessageFactory::serializeUserChatBoxRequest(ChatInteraction interaction, int chatboxID, std::string username, std::string message, int timestamp)
{
