...
public:
    ...
    /**
     * @brief In a Multiplayer Game, if somebody asks to pause the game we have to send a request to the Server which will handle the pause on each player's own
     * machine
     *
