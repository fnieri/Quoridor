...
public:
    ...
    constexpr inline int x() const noexcept { return m_x; }
    constexpr inline int y() const noexcept { return m_y; }

    constexpr void x(const int &_x) noexcept { m_x = _x; }
    constexpr void y(const int &_y) noexcept { m_y = _y; }
