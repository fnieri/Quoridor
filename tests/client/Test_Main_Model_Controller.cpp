...
SCENARIO("Testing requests")
{
    ...
    SECTION("RESOURCE_REQUEST Request") // how do we send a resource to the model then request it from the controller then check from the model again ? doesnt make sense ?
    {
